...
public class ReadCube : MonoBehaviour
{
    ...
    void Update()
    {
        ReadState(); // expensive but you can use it to demonstrate 
    }
    ...
    public void ReadState()
    {
        ...
        // set the state of each pos in the list of the sides
    ...
    {
        // craete rays lists with the rays going toward the cube
        ...
        for (int y = 1; y > -2; y--)
        {
            for (int x = -1; x < 2; x++)
            {
                Vector3 startPos = new Vector3(rayTransform.localPosition.x + x,
                                               ...
                                               rayTransform.localPosition.z); // stays the same
    ...
    public List<GameObject> ReadFace(List<GameObject> rayStarts, Transform rayTransform)
    {
        ...
        return facesHit;  // Update the cube state front face
    }
}
